...
public static partial class MaybeExtensions
{
    ...
    /// </summary>
    public static void ThenDo<TValue, TError>(this in Maybe<TValue, TError> maybe, Action<TValue> action) where TError : BaseError, new()
    {
        if (maybe.IsSuccess)
        {
    ...
    /// </summary>
    public static Task ThenDoAsync<TValue, TError>(this Maybe<TValue, TError> maybe, Func<TValue, Task> actionAsync) where TError : BaseError, new()
    {
    ...
    /// </summary>
    public static async Task ThenDo<TValue, TError>(this Task<Maybe<TValue, TError>> maybeTask, Action<TValue> action) where TError : BaseError, new()
    {
    ...
    /// </summary>
    public static async Task ThenDoAsync<TValue, TError>(this Task<Maybe<TValue, TError>> maybeTask, Func<TValue, Task> actionAsync) where TError : BaseError, new()
    {
        var maybe = await maybeTask.ConfigureAwait(false);
    ...
    /// </summary>
    public static void ElseDo<TValue, TError>(this in Maybe<TValue, TError> maybe, Action<TError> action) where TError : BaseError, new()
    {
        if (maybe.IsError)
        {
    ...
    /// </summary>
    public static Task ElseDoAsync<TValue, TError>(this Maybe<TValue, TError> maybe, Func<TError, Task> actionAsync) where TError : BaseError, new()
    {
    ...
    /// </summary>
    public static async Task ElseDo<TValue, TError>(this Task<Maybe<TValue, TError>> maybeTask, Action<TError> action) where TError : BaseError, new()
    {
        var maybe = await maybeTask.ConfigureAwait(false);
        maybe.ElseDo(action);
    }
    ...
    /// </summary>
    public static async Task ElseDoAsync<TValue, TError>(this Task<Maybe<TValue, TError>> maybeTask, Func<TError, Task> actionAsync) where TError : BaseError, new()
    {
        var maybe = await maybeTask.ConfigureAwait(false);
